...
APP_NAME = os.environ.get('APP_NAME', 'COMPANY')
...
SESSION_COOKIE_NAME = '{}-srv-company'.format(BUILD_ENV.lower())
...
INSTALLED_APPS = [
    ...
    'company_portal.apps.CompanyPortalConfig'
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'company_portal.context_processors.version_number',
                'company_portal.context_processors.environment'
            ],
        },
    },
]
...
SQLITE_DIR = BASE_DIR + "/../../SharedRideCompanyAppSQLite/"
...
if BUILD_ENV != "LOCAL":
    ...
    LOGGING["handlers"]["default"]["filename"] = '/sfo/webapplications/djangoApps/SharedRideCompanyApp/logs/srv_django.log/'

TOKEN_EXPIRE_TIME_HOURS = 12

SERVICE_AUTH_HEADER = {"authorization": "Basic U0ZPLVNSVkBmbHlzZm8uY29tOkludGVybmF0aW9uYWwyMDE3IQ=="}
