...
APP_NAME = os.environ.get('APP_NAME', 'COORDINATOR')
...
SESSION_COOKIE_NAME = '{}-srv-coordinator'.format(BUILD_ENV.lower())
...
INSTALLED_APPS = [
    ...
    'coordinator_portal.apps.CoordinatorPortalConfig'
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'coordinator_portal.context_processors.version_number',
                'coordinator_portal.context_processors.environment'
            ],
        },
    },
]
...
SQLITE_DIR = BASE_DIR + "/../../SharedRideCoordinatorAppSQLite/"
...
if BUILD_ENV != "LOCAL":
    ...
    LOGGING["handlers"]["default"]["filename"] = '/sfo/webapplications/djangoApps/SharedRideCoordinatorApp/logs/srv_django.log/'
...
elif BUILD_ENV == "qa-coordinator":
    ALLOWED_HOSTS = ['#REDACTED#']
elif BUILD_ENV == "stg-coordinator":
    ALLOWED_HOSTS = ['#REDACTED#']
elif BUILD_ENV == "prd-coordinator":
    ALLOWED_HOSTS = ['#REDACTED#']